var size = 0;
var placement = 'point';
function categories_NHWhiteNHBlack_0(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case '1 NHB-resilient & NHW-resilient':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '2 NHB-resilient & NHW-at risk':
                    return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '3 NHB-at risk & NHW-resilient':
                    return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '4 NHB-at risk & NHW-at risk':
                    return [ new ol.style.Style({
...
case '5 Other':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(198,199,210,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_NHWhiteNHBlack_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("census_tract_cross_NHW_NHB_cross");
    ...
    var style = categories_NHWhiteNHBlack_0(feature, value, size, resolution, labelText,
